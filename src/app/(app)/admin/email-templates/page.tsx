...
export const studentPlaceholders = [
  ...
  { key: "{{linkCertificadoAntecedentes}}", description: "Enlace de descarga del Certificado de Antecedentes." },
  { key: "{{linkCertificadoInhabilidadesMenores}}", description: "Enlace de descarga del Certificado de Inhabilidades para trabajar con menores." },
  { key: "{{linkCertificadoInhabilidadesMaltrato}}", description: "Enlace de descarga del Certificado de Inhabilidades por maltrato relevante." }
];
...
export const DEFAULT_STUDENT_EMAIL_BODY_TEXT = `Estimado/a estudiante {{estudiante.nombre}} {{estudiante.ap_paterno}} {{estudiante.ap_materno}},
